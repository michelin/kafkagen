# Contributing to Kafkagen

Welcome and thank you for considering contributing to Kafkagen!
...
The configuration file is defined in the `checkstyle.xml` file.
...
- Configure the plugin to use Kafkagen's Checkstyle configuration file.
